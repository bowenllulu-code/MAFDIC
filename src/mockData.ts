...
export const customers: Customer[] = [
  {
    ...
    revenueYtd: 1260000,
    serviceTier: "战略客户",
    investmentPreference: "稳健固收、低波动权益增强",
    operationFocus: "关注大额申购确认、垫资额度和商机归因收入。",
    nextBestActions: ["复核申购确认金额", "检查垫资额度使用率", "同步客户经理商机落地表现"],
  },
  {
    id: "C002",
    name: "东海保险资管专户",
    ...
    revenueYtd: 980000,
    serviceTier: "重点客户",
    investmentPreference: "货币增强、流动性管理",
    operationFocus: "赎回确认超时正在影响资产出账，需要优先闭环。",
    nextBestActions: ["核对 TA 回执", "生成赎回确认说明", "通知清算岗复核映射关系"],
  },
  {
    id: "C003",
    name: "南方制造产业基金会",
    ...
    revenueYtd: 420000,
    serviceTier: "成长客户",
    investmentPreference: "指数配置、长期持有",
    operationFocus: "净值波动需要补充解释口径，并进入客户周报。",
    nextBestActions: ["补充行情解释", "查看持仓浮盈亏", "加入周报草稿"],
  },
];
...
export const orders: TransactionOrder[] = [
  {
    ...
    channel: "机构直销",
    confirmationBlocker: "TA 回执已进入确认队列，待清算岗复核份额和确认金额。",
    assetImpact: "申购确认后预计增加客户持仓和资产规模，影响当日保有量统计。",
    settlementTrail: ["申请提交 · 2026-05-18", "TA 回执进入队列 · 2026-05-19 09:20", "待清算复核确认金额"],
    nextActions: ["核对确认金额", "查看客户持仓", "生成状态说明"],
  },
  {
    id: "T20260517009",
    customerId: "C002",
    ...
    channel: "代销渠道 A",
    confirmationBlocker: "TA 回执与申请单映射未匹配，赎回确认超时。",
    assetImpact: "赎回未确认会延迟资产出账与客户可用份额更新，需要优先处理。",
    settlementTrail: ["申请提交 · 2026-05-17", "渠道回传待核验 · 2026-05-18 10:40", "确认超时预警 · 2026-05-19 09:12"],
    nextActions: ["核对 TA 回执", "查看关联风险", "创建清算复核"],
  },
  {
    id: "T20260516012",
    customerId: "C003",
    ...
    channel: "机构直销",
    confirmationBlocker: "确认链路已完成，当前无待处理卡点。",
    assetImpact: "申购已计入客户持仓，后续重点关注净值波动对浮盈亏的影响。",
    settlementTrail: ["申请提交 · 2026-05-16", "TA 确认完成 · 2026-05-17 11:15", "持仓入账 · 2026-05-17 15:00"],
    nextActions: ["查看客户持仓", "补充行情解释", "加入周报草稿"],
  },
];
...
export const risks: RiskEvent[] = [
  {
    ...
    currentBlocker: "TA 回执与申请单映射未完成，赎回确认无法进入清算闭环。",
    nextActions: ["查看关联订单", "核对 TA 回执", "生成客户经理说明", "创建清算复核任务"],
    handlingRecords: ["09:18 系统命中 T+1 未确认规则", "09:24 运营岗补充申请单编号", "09:31 等待清算岗复核 TA 回执"],
  },
  {
    id: "R002",
    title: "垫资额度接近上限",
    ...
    currentBlocker: "额度使用率已接近预警线，后续申购计划与授权额度需要重新核对。",
    nextActions: ["查看额度配置", "核对后续申购", "发起额度调整审批", "通知客户经理"],
    handlingRecords: ["10:30 系统触发额度使用率预警", "10:36 运营岗确认今日仍有申购计划", "10:42 建议配置岗复核垫资额度"],
  },
  {
    id: "R003",
    title: "基金净值波动提醒",
    ...
    currentBlocker: "净值波动已影响客户持仓浮盈亏，需要在经营报告中补充解释口径。",
    nextActions: ["查看客户持仓", "补充行情解释", "加入周报草稿", "关注后续净值"],
    handlingRecords: ["17:00 行情波动监控触发提醒", "17:08 已关联客户持仓影响", "17:15 等待周报生成时补充说明"],
  },
];
...
export const opportunities: Opportunity[] = [
  {
    ...
    linkedOrders: [
      { orderId: "T20260519001", allocationRatio: 70, note: "华北城投申购交易确认后形成主要持仓收入" },
      { orderId: "T20260517009", allocationRatio: 30, note: "东海资管赎回交易仅归因流动性方案协同贡献" },
    ],
    salesSplits: [
      { salesName: "林越", role: "主办销售", ratio: 70 },
      { salesName: "周辰", role: "协同销售", ratio: 30 },
    ],
    stage: "交易已落地",
  ...
  },
  {
    ...
    linkedOrders: [
      { orderId: "T20260517009", allocationRatio: 100, note: "交易确认后才可形成可确认收入" },
    ],
    salesSplits: [
      { salesName: "周辰", role: "主办销售", ratio: 100 },
    ],
    stage: "方案确认",
  ...
  },
  {
    ...
    linkedOrders: [
      { orderId: "T20260516012", allocationRatio: 80, note: "投后跟踪交易按 80% 计入试点商机" },
    ],
    salesSplits: [
      { salesName: "陈静", role: "主办销售", ratio: 80 },
      { salesName: "林越", role: "产品协同", ratio: 20 },
    ],
    stage: "投后跟踪",
...
export const opportunityAttributions: OpportunityAttribution[] = [
  {
    ...
    opportunityAllocationRatio: 70,
    salesMaintenanceFee: 260000,
    distributionServiceFee: 160000,
  ...
  },
  {
    ...
    opportunityAllocationRatio: 100,
    salesMaintenanceFee: 0,
    distributionServiceFee: 0,
    revenueAmount: 0,
    feeAmount: 0,
    netContribution: 0,
  ...
  },
  {
    ...
    opportunityAllocationRatio: 80,
    salesMaintenanceFee: 62000,
    distributionServiceFee: 34000,
    revenueAmount: 96000,
    feeAmount: 14000,
